...
int main() {
    int width = 30;  // Largeur de la map
    int height = 20; // Hauteur de la map
    float openRatio = 0.8; // Ratio de cases ouvertes (50%)
    int collectibleCount = 31; // Nombre de collectibles
